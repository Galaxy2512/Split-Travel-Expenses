...
Korištenje
    ...
    Dodavanje korisnika: Koristite lijevi panel za dodavanje prijatelja.
    Dodavanje troškova: Unesite podatke o troškovima u lijevi panel i pošaljite.
    Dijeljenje računa: Desni panel prikazuje podijeljene troškove.
    Izvoz podataka: Koristite traku izbornika za izvoz podataka u CSV, tekstualni ili binarni format.
    Uvoz podataka: Koristite traku izbornika za uvoz podataka iz datoteke.
    Brisanje svih podataka iz baze podataka: Koristite traku izbornika za brisanje svih podataka.
    Prikaz podataka: Prikazuje podatke o korisnicima, troškovima i dijeljenju računa iz baze podataka te se mogu nadodavati novi podaci.
